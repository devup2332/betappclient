...
import { IconArrowDown, IconCamera, IconSave, LoadingIcon } from "../components/atoms/icons";
...
const ProfileUserContainer = () => {
    ...
    return (
        <div className="w-full pt-5 px-5 max-w-sm m-auto lg:max-w-none lg:pt-10 lg:px-10" onClick={handleGeneralClick}>
            <div className="flex justify-between lg:justify-start lg:gap-10 font-montserrat xl:justify-end">
            ...
            <div className="mt-10 grid gap-12 xl:grid-cols-2">
                <div
                    className="rounded-full overflow-hidden w-48 h-48 m-auto relative lg:w-72 lg:h-72 lg:m-0 xl:w-96 xl:h-96"
                ...
                >
                    ...
                    />
                    <input type="file" accept="image/png, image/jpeg,image/jpg" hidden ref={inputFileRef} />
                ...
                <form
                    className="grid gap-5 lg:grid-cols-2 lg:gap-10 xl:grid-cols-1"
